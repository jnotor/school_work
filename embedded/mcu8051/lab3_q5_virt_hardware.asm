; **********************************************************************************************************************
; * Port01 test READ program   Ver 001
; * J. Notorgiacomo 10/07/2020
; * Description: Reads 8 bits on one port and outputs the result to Port 3 LEDs
...
MOV A, P1		; W.E. value that was found on Port 1 will be stored in the Accumulator. Imagine as universal storage.
