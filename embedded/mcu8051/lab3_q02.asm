; **********************************************************************************************************************
; * Port02 test WRITE program   Ver 001
...
MOV P2, #00H    ; Write all "0"s to Port 1. No leading zero required. NOTE: consuming 3 bytes
NOP             ; No operation. Effectively wastes 1 instruction cycles worth of time. NOTE: consumes 1 byte
NOP
MOV P2, #0FFH   ; Write all "1"s to port 1. NOTE: leading '0' in the hex required for letter after #. consuming 3 bytes
