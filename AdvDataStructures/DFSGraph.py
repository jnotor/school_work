...
# DFS(s) traverses vertices reachable from s. from https://www.geeksforgeeks.org/iterative-depth-first-traversal/
class Graph:
	def __init__(self, V):
		self.V = V
...
if __name__ == '__main__':
	...
	print("Following is Depth First Traversal starting from 0")
	g.DFS()
