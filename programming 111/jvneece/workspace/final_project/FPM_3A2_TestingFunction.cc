// testing bust checker and ace checker
//
...
////////////////////////////////////////////////////////////////////////////////player hand			
			...
			aceFlag = gameDeck.aceChecker(firstCard);							//check for an ace
			cout << "and ";
			secondCard = gameDeck.getNextCard(1, user.getScore());
			
			if (aceFlag == false)   {											//check for an ace only if player doesnt already have an ace
...
////////////////////////////////Decisions, Decisions
					...
					case 1: 													//hit
						...
						validResponse = false;													
						round += 1;
						if (aceFlag == false)   {											//check for an ace only if player doesnt already have an ace; only checks for ace value == 11, because we dont care if they have an ace valued at 1
							aceFlag = gameDeck.aceChecker(value);
						}
///////////////// Check Score
						user.bustChecker(user.getScore(), aceFlag);
