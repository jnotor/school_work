...
int Deck::getNextValue(int round, int score) {                                   // Definition of getNextCard function, gets and returns the face value of the card, also couts a message
...
void Deck::showNextCard(int faceValue)   {
		suit = getSuit();
		switch (faceValue) {
		case 0:
			cout << "Ace of " << suit << endl;
