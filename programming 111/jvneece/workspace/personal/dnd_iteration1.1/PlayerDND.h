...
class PlayerDND {
	public:
		PlayerDND();																// Declaration of Player Class Default Constructor
		PlayerDND(int, int, int, int,int, bool,string);												//dec of player with passed base stats
...
PlayerDND::PlayerDND() {																// Default constructor of the Player Class, sets initial score as 0 and initial chips as 200
...
PlayerDND::PlayerDND(int iAC, int iHP, int itoHit, int iavgDmg, int iIntMod, bool iParty, string iName)   {								//defined player being passed its base stats
